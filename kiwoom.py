...
class Kiwoom(QAxWidget):
    def __init__(self):
        ...
        self.not_conclude_account()#미체결 요청
    ...
    def get_account_info(self):
        ...
        print("나의 보유 계좌번호 %s" % self.account_num) #8046349511
    ...
    def trdata_slot(self, sScrNo, sRQName, sTrCode, sRecordName, sPrevNext):
        ...
        if sRQName == "주식일봉차트조회":
            ...
            #한번 조회하면 600일 까지 일봉데이터를 받을 수 있다
            for i in range(cnt):
                data = []
            ...
            if sPrevNext == "2":
                ...
                if self.calcul_data == None or len(self.calcul_data) < 120:
                    ...
                    prev_price = None # 과거의 일봉차트
                    if bottom_stock_price == True:
                        moving_average_price = 0
                        price_top_movine = False
                        ...
                        while True:
                            ...
                            if moving_average_price <= int(self.calcul_data[idx][6]) and idx <= 20:
                                print("20일 동안 주가가 120일 이평선과 같거나 위에 있으면 조건 통과 못하")
                                price_top_movine = False
                                break
    ...
    def day_kiwoom_db(self, code=None, date='20230504', sPrevNext="0"):
        ...
        if date != None:
            ...
            self.dynamicCall("CommRqData(QString, QString, int, QSting)", "주식일봉차트조회", "opt10081", sPrevNext, self.screen_calculation_stock)
